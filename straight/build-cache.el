...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2021-11-23 15:59:32" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2021-11-23 15:59:32" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2021-11-23 15:59:32" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2021-11-23 15:59:32" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2021-11-23 15:59:32" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2021-11-23 15:59:32" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2021-11-23 15:59:32" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2021-11-23 15:59:32" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "org-transclusion" ("2021-11-23 15:59:33" ("emacs" "org") (:type git :host github :repo "nobiot/org-transclusion" :package "org-transclusion" :local-repo "org-transclusion")) "org" ("2021-11-23 15:59:33" ("emacs") (:type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org"))))
...
with the specified `:load-path' the module cannot be found." t nil) (register-definition-prefixes "use-package-lint" '("use-package-lint-declaration")) (provide 'use-package-autoloads)) "org" ((org-table ol ol-eww org-macro ob-ditaa ob-eshell ob-css org-entities ox-html ob-lisp ox-ascii ob-java ob-ruby ob-shell ob-hledger org-faces ob-sqlite ob-screen org-src ol-rmail ox-odt ol-doi ob-stan org-list ol-info org-macs ob-table oc-biblatex ob-J org-num ob-perl ox-koma-letter ob-scheme ob-haskell ob-org ob-js oc-csl org-capture ox-beamer org-mobile org-indent ol-eshell org-goto org-clock ox ol-docview ob-dot ob-shen org-feed org-ctags ob-octave oc-natbib org ob-vala org-element org-attach ob-makefile org-colview ob-R ob-latex ob-forth ob-sql ol-irc ob ob-matlab ob-groovy ob-ocaml ob-sass org-plot ob-io ob-exp org-timer ob-plantuml ob-gnuplot ox-publish ob-processing ob-coq ol-bbdb org-footnote ob-clojure org-loaddefs ob-emacs-lisp ob-ref org-tempo ox-org org-version ob-awk org-duration ob-maxima ob-python org-pcomplete org-archive ob-abc org-inlinetask ol-gnus org-agenda org-refile ob-tangle ox-md org-attach-git ol-mhe ob-lilypond org-habit org-datetree ob-core org-keys org-crypt ox-latex ox-texinfo ox-icalendar ob-comint org-compat org-id org-lint oc ob-mscgen ob-calc ob-ebnf ob-eval ob-lua ox-man ob-sed ob-ledger ob-fortran ob-asymptote ol-bibtex org-protocol org-install ol-w3m oc-basic ob-picolisp ob-C ob-lob org-mouse)) "org-transclusion" ((org-transclusion text-clone org-transclusion-autoloads) (autoload 'org-transclusion-mode "org-transclusion" "Toggle Org-transclusion minor mode.
...
\\{org-transclusion-map}" t nil) (autoload 'org-transclusion-add-all "org-transclusion" "Add all active transclusions in the current buffer.
...
(fn &optional NARROWED)" t nil) (register-definition-prefixes "org-transclusion" '("org-transclusion-")) (register-definition-prefixes "text-clone" '("text-clone-")) (provide 'org-transclusion-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 9 "melpa" nil "gnu-elpa-mirror" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "org-transclusion" nil "org" (org :type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*"))))) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "org-transclusion" nil)) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "org-transclusion" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "emacsmirror-mirror" nil "straight" nil "org-transclusion" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "org-transclusion" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "org-transclusion" "org")
